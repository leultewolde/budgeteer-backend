...
public class ActualIncomeE2ETest {
    ...
    @Test
    @Order(1)
    void addActualIncome_ShouldCreateIncome() {
    ...
    @Test
    @Order(3)
    void updateActualIncome_ShouldUpdateIncome() {
    ...
    @Test
    @Order(4)
    void deleteActualIncome_ShouldDeleteIncome() {
        given()
                .contentType("application/json")
                .when()
                .delete("/actual-incomes/1")
                .then()
                .statusCode(204);
    }
}
